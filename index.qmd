...
# Determine coding time personality from events data
time_periods = [
    ("Night", range(0, 6)),
    ("Morning", range(6, 12)),
...
time_reveals = {
    "Night": {
        "title": "NIGHT OWL",
        "subtitle": "The moon is your coding companion",
        "desc": "While the world sleeps, you're shipping features. Your best work happens when the stars come out.",
        "emoji": "🦉"
    },
    "Morning": {
        "title": "EARLY BIRD", 
        "subtitle": "First commits before first coffee",
        "desc": "You catch the worm and the merge conflicts. Dawn is your domain, and your code is crispier than morning toast.",
        "emoji": "🌅"
    },
    "Afternoon": {
        "title": "AFTERNOON WARRIOR",
        "subtitle": "Peak productivity hours",
        "desc": "Post-lunch power moves. When others hit the afternoon slump, you hit your stride.",
        "emoji": "☀️"
    },
    "Evening": {
        "title": "EVENING CODER",
        "subtitle": "Golden hour, golden commits",
        "desc": "As the day winds down, your keyboard heats up. Sunset sessions are where your magic happens.",
        "emoji": "🌆"
    }
}
...
# Add dramatic reveal card
heatmap_html += f'''
<div class="time-reveal-card">
    <div class="reveal-label">You're a...</div>
    <div class="reveal-emoji">{reveal["emoji"]}</div>
    <div class="reveal-title">{reveal["title"]}</div>
    <div class="reveal-subtitle">{reveal["subtitle"]}</div>
    <div class="reveal-desc">{reveal["desc"]}</div>
</div>
'''
